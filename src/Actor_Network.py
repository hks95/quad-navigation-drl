...
class Actor_Network(object):
	...
	def create_actor(self):
		'''
		Define the network for the actor here
		Modify self.hidden_dim to suit your purpose
		Dont call this function if you are planning to load pre trained models
		'''
